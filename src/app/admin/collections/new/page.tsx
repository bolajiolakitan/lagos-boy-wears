    ...
    return (
        <div className="container" style={{ padding: "3rem 1.5rem", maxWidth: "800px" }}>
            <div style={{ marginBottom: "2.5rem" }}>
                ...
                <h1 style={{ marginTop: "0.75rem", fontSize: "clamp(1.5rem, 3vw, 2rem)" }}>ADD COLLECTION / DROP</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: "grid", gap: "2rem" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    ...
                    <label htmlFor="isActive" style={{ fontFamily: "var(--font-body)", fontWeight: 600, fontSize: "0.85rem", cursor: "pointer" }}>
                        Make this collection active immediately
                    </label>
                </div>
                ...
                <button
                    ...
                    disabled={loading}
                >
                    {loading ? "Creating Drop..." : "Publish Collection"}
                </button>
            </form>
        </div>
    );
